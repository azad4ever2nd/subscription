...
export default defineGkdApp({
  ...
  groups: [
    ...
    },
    {
      key: 9,
      name: '弹窗2，与分期有关，X掉',
      desc: '260831，替换规则3，添加 开通碰一下，推送服务，查询账单，返回领奖，到桌面，银行卡抽奖，升级月利宝',
      rules: [
        {
          resetMatch: 'match',
          actionCd: 0,
    ...
    },
    {
      key: 10,
      name: '推荐开通花呗',
      desc: '260829，添加 支付宝推荐你，关闭PDD免密付款，添加放弃还款，推荐习惯，([text^="支付宝推荐" || text^="支付宝  推荐"] < * +n * > [text="关闭"]) ||',
      rules: [
        {
          resetMatch: 'match',
          fastQuery: true,
