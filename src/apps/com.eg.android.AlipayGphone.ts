...
export default defineGkdApp({
  ...
  groups: [
    ...
    },
    {
      key: 9,
      name: '弹窗2，与分期有关，X掉',
      desc: '260829，替换规则3，添加 开通碰一下，推送服务，查询账单，返回领奖，到桌面，银行卡抽奖，升级月利宝',
      rules: [
        {
          resetMatch: 'match',
          actionCd: 0,
