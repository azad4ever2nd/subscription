  ...
  groups: [
    {
      key: 1,
      name: '签到',
      desc: '260607,签到改版，[text="会员签到"] [text="立即签到"]',
      rules: [
        {
          resetMatch: 'match',
          actionMaximum: 3,
          ...
          matches:
            '([text="去签到，按钮"]) || (View[text="会员签到"] >n Button[text="立即签到"]) || (View > TextView[text="会员专属活动"] + Image) || (TextView[text="会员专属活动"] + Image[clickable=true]) || (View > Button[text="立即签到"])',
        },
      ],
    },
    {
